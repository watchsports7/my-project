...
class Tag(models.Model):
    ...
    # ✅ добавляем промежуточную таблицу для связи Article ↔ Tag (для автоподсказок)
...
class Article(models.Model):
    ...
    tags = TaggableManager(verbose_name="Теги", help_text="Введите теги через запятую (автоподсказка включена)", blank=True)  # ✅ автоподсказки
...
class ArticleView(models.Model):
    article = models.ForeignKey(Article, on_delete=models.CASCADE, related_name='article_log')
